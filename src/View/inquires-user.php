...
<div class="container py-5">
    <div class="d-between">
        ...
        <button class="btn-filled" data-target="#insert-modal" data-toggle="modal">문의하기</button>
    </div>
...
<form id="insert-modal" class="modal fade" action="/insert/inquires" method="post">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
